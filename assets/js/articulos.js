/* LÓGICA DEL CARRUSEL DE ARTÍCULOS (VERSIÓN FIABLE) */
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const articles = [
        ...
        },
        {
            ...
            image: "https://images.unsplash.com/photo-1607799275518-d580e8105d86?auto=format&fit=crop&w=800&q=80",
            category: "teoria",
            tag: "DEVSECOPS",
            date: "20 OCT",
            readTime: "6 MIN"
    ...
    function renderArticles(filter = 'all') {
        ...
        if (filtered.length === 0) {
            track.innerHTML = `<div class="art-empty">No hay registros.</div>`;
            return;
        }
